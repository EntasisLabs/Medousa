...
pub use packages::{
    ...
    package_composition, package_disk_estimate_bytes, package_short_hint, phase_label,
    resolve_package_alias, sort_for_install, visible_catalog, PackageCatalogEntry, PackageCategory,
    PackageComposition, PackageProfile,
};
