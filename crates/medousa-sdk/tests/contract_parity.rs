...
pub const PARITY_ROUTES: &[(&str, &str, &str, &str)] = &[
    ...
    ("calendar", "update_event", "PUT", "/v1/calendar/events/{uid}"),
    ("calendar", "delete_event", "DELETE", "/v1/calendar/events/{uid}"),
    ("calendar", "import_ics", "POST", "/v1/calendar/import"),
    ("calendar", "export", "GET", "/v1/calendar/export"),
