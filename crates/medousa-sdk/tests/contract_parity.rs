...
pub const PARITY_ROUTES: &[(&str, &str, &str, &str)] = &[
    ...
    ("sessions", "agent_mode", "GET", "/v1/sessions/{id}/agent-mode"),
    ("sessions", "set_agent_mode", "PUT", "/v1/sessions/{id}/agent-mode"),
    ("sessions", "clear_agent_mode", "DELETE", "/v1/sessions/{id}/agent-mode"),
    ("sessions", "agent_mode_proposals", "GET", "/v1/sessions/{id}/agent-mode/proposals"),
    ("sessions", "decide_agent_mode_proposal", "PUT", "/v1/sessions/{id}/agent-mode/proposals/{proposal_id}"),
    ...
    ("agents", "list_runtimes", "GET", "/v1/agents/runtimes"),
    ("agents", "create_session", "POST", "/v1/agents/sessions"),
    ("agents", "prompt", "POST", "/v1/agents/sessions/{id}/prompt"),
    ("agents", "stream", "SSE", "/v1/agents/sessions/{id}/stream"),
    ("agents", "cancel", "POST", "/v1/agents/sessions/{id}/cancel"),
    ("agents", "list_permission_requests", "GET", "/v1/agents/permission-requests"),
    ...
    ("runtime", "agent_mode_transition_policy", "GET", "/v1/agent-modes/policy"),
    ("runtime", "set_agent_mode_transition_policy", "PUT", "/v1/agent-modes/policy"),
