...
let package = Package(
    ...
    dependencies: [
        // Xcode 27's Metal headers overlap with the MLX 0.31.x bf16 helpers.
        // Keep the LM API pinned while using our reviewed Xcode 27-compatible
        // low-level MLX snapshot.
