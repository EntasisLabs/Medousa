...
// Xcode 27's Metal compiler ships these overloads in metal_math even when it
// targets Metal language 3.0. Re-declaring them is rejected. Older compiler
// generations still need MLX's compatibility overloads below.
#if !defined(__clang_major__) || (__clang_major__ < 32023)
