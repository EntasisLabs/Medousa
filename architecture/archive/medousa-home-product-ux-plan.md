...
> **Status:** **M7 surfaces shipped** — nav tiers (life / capability / utility), Work Hub manifestations, Settings charter = [M11 plan](medousa-home-m11-settings-charter-plan.md); Messaging polish = [messaging polish plan](medousa-home-messaging-polish-plan.md)  
> **Date:** 2026-05-30  
