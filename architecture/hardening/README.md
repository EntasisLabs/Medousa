...
| H07 | [07-vault-scaling-and-consistency.md](07-vault-scaling-and-consistency.md) | Incremental index, atomic mutation, backend/frontend lookups | PERF-003, PERF-006, CONSIST-001 | ADR-014, ADR-016 | Implementing; H07.0–H07.5 landed; packaged multi-OS validation pending |
...
| PERF-003 | High | H07 | C | Mitigated; retained multi-OS evidence pending | Vault cold/warm scaling benchmark (P06 harness) |
| CONSIST-001 | High | H07 | B | Mitigated; retained multi-OS evidence pending | Atomic compare-and-write race test (CM-006) |
...
| PERF-006 | High | H07 | C | Mitigated; retained multi-OS evidence pending | Large-vault tree/link interaction benchmark |
