...
| H07 | [07-vault-scaling-and-consistency.md](07-vault-scaling-and-consistency.md) | Incremental index, atomic mutation, backend/frontend lookups | PERF-003, PERF-006, CONSIST-001 | ADR-014, ADR-016 | Implementing; repair cars R0–R7 landed; Validated evidence pending |
...
| PERF-003 | High | H07 | C | Mitigated | Vault cold/warm scaling benchmark (P06 harness); Validated needs retained multi-OS tables |
| CONSIST-001 | High | H07 | B | Mitigated | Atomic compare-and-write race test (CM-006); Validated needs retained multi-OS crash matrix |
...
| PERF-006 | High | H07 | C | Mitigated | Large-vault tree/link interaction benchmark; Validated needs retained P07 multi-OS evidence |
