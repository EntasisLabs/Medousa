...
| H07 | [07-vault-scaling-and-consistency.md](07-vault-scaling-and-consistency.md) | Incremental index, atomic mutation, backend/frontend lookups | PERF-003, PERF-006, CONSIST-001 | ADR-014, ADR-016 | Implementing; repair train in progress; H07.0 scaffolding only |
...
| PERF-003 | High | H07 | C | Proposed | Vault cold/warm scaling benchmark (P06 harness) |
| CONSIST-001 | High | H07 | B | Proposed | Atomic compare-and-write race test (CM-006) |
