...
| Docs / Operator’s Guide | [operators-guide-docs-epic.md](operators-guide-docs-epic.md) | ✅ **D0–D3** (32 chapters); maintain via `npm run guide:generate` + governance checklist |
