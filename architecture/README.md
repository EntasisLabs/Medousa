...
| [ios-siri-app-intents-roadmap.md](ios-siri-app-intents-roadmap.md) | **Siri + Apple Intelligence** — App Intents, entities, onscreen context, typed actions, and Visual Intelligence |
