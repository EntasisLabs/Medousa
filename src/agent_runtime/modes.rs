...
◈⟨ ⏣0{
    ...
    execution_policy(.99): {
        ...
        peer_subagents(.99): "cognition_turn_begin_work and cognition_spawn_turn_worker spawn peer sub-agents for parallel research or side tasks; they do not leave Coder or enter the Chat workshop lane.",
