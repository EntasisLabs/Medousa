...
pub fn build_ambient_context(input: AmbientContextInput<'_>) -> AmbientContextBlock {
    ...
    let mut lines = vec![
        ...
        "early_exit=allowed_end_turn_early_with_cognition_turn_finish_when_done_or_cognition_turn_begin_work_for_progress_or_ask_one_sharp_clarifying_question_instead_of_burning_remaining_rounds".to_string(),
    ];
