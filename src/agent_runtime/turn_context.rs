...
fn default_worker_constraints() -> Vec<String> {
    vec![
        ...
        "Prefer cognition_turn_finish with the full reply when done; use cognition_turn_begin_work for a progress line before heavy tools; end early when task is done".to_string(),
    ]
}
