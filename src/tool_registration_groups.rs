...
use crate::typed_tools::{ToolRegistrar, ToolRegistration};
...
/// Register the shared tools that precede the optional OpenShell family.
pub fn register_shared_foundation_tools(
