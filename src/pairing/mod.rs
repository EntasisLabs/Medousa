...
pub use service::{
    ...
    QrResponse, RevokePairingResult, init_workshop_pairing, mdns_enabled_from_env,
    mdns_should_advertise, pairing_enabled_from_env, pairing_qr_v1_from_env,
    resolve_advertise_address, resolve_peer_name, resolve_request_profile_id, workshop_pairing,
};
