...
mod tests {
    ...
    use super::{
        ...
        build_report_prompt, compile_lane_prompt, apply_dashboard_action_auth, dashboard_router,
        default_heartbeat_lane_policy, derive_job_result_status, enforce_lane_safety,
        parse_dashboard_action_auth, extract_citations_from_payload, parse_backend,
    };
