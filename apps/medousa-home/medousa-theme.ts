...
export const medousaTheme: CustomThemeConfig = {
  ...
  properties: {
    ...
    '--color-primary-400': '153 104 255',
    '--color-primary-50': '237 233 254',
    '--color-primary-500': '131 68 245',
    ...
    '--color-surface-300': '188 188 204',
    '--color-surface-400': '172 172 188',
    ...
    '--theme-font-color-base': '232 232 244',
    '--theme-font-color-dark': '232 232 244',
