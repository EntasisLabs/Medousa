# How Medousa fits together

A few names show up everywhere. Knowing them avoids most confusion.
...
Settings → Sharing → **Shared** lets several people use seats on one shared workshop. Only turn this on when you mean to share. Details: [Sharing and phone](guide:sharing-phone).
