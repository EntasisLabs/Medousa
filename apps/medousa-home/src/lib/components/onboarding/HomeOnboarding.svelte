              ...
              {#each packageIds as packageId (packageId)}
                ...
                <div class="home-package-row">
                  ...
                  {#if packageFailures[packageId]}
                    <small class="text-warning-300">Try again in Settings → Packages</small>
                  {:else if progress?.percent === 100}
                    <small class="text-success-300">Ready</small>
                  {:else}
...
<style>
  ...
  .home-onboarding-kicker { margin: 0; font-size: 0.65rem; font-weight: 650; letter-spacing: 0.16em; text-transform: uppercase; color: rgb(var(--color-primary-300)); }
  ...
  .home-onboarding-copy > p:last-child { margin: 0.65rem 0 0; max-width: 36rem; color: rgb(var(--color-surface-300)); line-height: 1.55; }
  ...
  .home-onboarding-choice { display: flex; min-width: 0; align-items: flex-start; gap: 0.75rem; padding: 1rem; border: 1px solid rgb(var(--color-surface-500) / 0.3); border-radius: 0.8rem; background: rgb(var(--color-surface-900) / 0.48); text-align: left; color: rgb(var(--color-surface-300)); }
  ...
  .home-onboarding-choice small, .home-layout-options small { display: block; margin-top: 0.22rem; color: rgb(var(--color-surface-400)); font-size: 0.72rem; line-height: 1.4; }
  ...
  .home-onboarding-channels p { margin: 0 0 0.55rem; font-size: 0.72rem; color: rgb(var(--color-surface-300)); }
  .home-onboarding-channels > div { display: flex; flex-wrap: wrap; gap: 0.4rem; }
  .home-onboarding-channels button { padding: 0.35rem 0.65rem; border: 1px solid rgb(var(--color-surface-500) / 0.35); border-radius: 999px; font-size: 0.72rem; color: rgb(var(--color-surface-300)); }
  ...
  .home-onboarding-error { margin: 0.7rem 0 0; color: rgb(var(--color-error-300)); font-size: 0.75rem; }
  ...
  .home-layout-pane small { color: rgb(var(--color-surface-500)); font-size: 0.65rem; }
  ...
  .home-layout-options button { display: flex; align-items: flex-start; gap: 0.65rem; padding: 0.8rem; border: 1px solid rgb(var(--color-surface-500) / 0.28); border-radius: 0.7rem; background: rgb(var(--color-surface-900) / 0.45); text-align: left; color: rgb(var(--color-surface-400)); }
