...
{#if open}
  <div
    class="vault-quick-switcher-backdrop fixed inset-0 z-[90] flex items-start justify-center bg-surface-950/70 p-4 pt-[12vh]"
    role="presentation"
    onclick={(event) => {
  ...
  >
    <div
      class="vault-quick-switcher-panel w-full max-w-xl overflow-hidden rounded-xl border border-surface-700/60 bg-surface-900 shadow-2xl"
      role="dialog"
      aria-modal="true"
