...
{#if open}
  ...
  <div
    ...
    role="menu"
    aria-label="Choose a chat for this note"
  >
    <p class="vault-note-chat-session-menu-heading">Talk about this note</p>
    <button
      type="button"
      role="menuitem"
    ...
    >
      ...
      <span class="min-w-0 flex-1 text-left">
        ...
        <span class="block text-[11px] text-content-tertiary">Start fresh with this note in scope</span>
      </span>
    </button>
