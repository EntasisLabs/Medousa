<script lang="ts">
  ...
  const items: SlashItem[] = [
    ...
    { id: "liquid_tabs", label: "Tabs", hint: "```tabs", keywords: "liquid tabs panels switcher" },
    { id: "liquid_steps", label: "Steps", hint: "```steps", keywords: "liquid steps numbered howto" },
    { id: "liquid_accordion", label: "Accordion", hint: "```accordion", keywords: "liquid accordion collapse faq" },
    { id: "liquid_code", label: "Code snippet", hint: "```code", keywords: "liquid code snippet copy diff" },
    { id: "liquid_tree", label: "File tree", hint: "```tree", keywords: "liquid tree files folders" },
