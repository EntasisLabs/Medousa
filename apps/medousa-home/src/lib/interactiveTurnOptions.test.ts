...
import { buildInteractiveTurnOptions } from "./interactiveTurnOptions";
...
describe("interactive chat model routing", () => {
  ...
  it("pins the first submitted model and routing, independent of other chats and defaults", () => {
    ...
    expect(next).toMatchObject({ responseDepthMode: "deep", reasoningEffort: "high", identityUserId: "user-1" });
  });
