...
fn run_home() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            daemon::contract_bridge::daemon_unary,
            ...
            mcp_gateway::mcp_gateway_list_tools,
            ...
            mcp_gateway::mcp_gateway_update_tool,
            ...
            daemon::calendar::calendar_delete_event,
            daemon::calendar::calendar_import_ics,
            daemon::calendar::calendar_export,
            ...
            daemon::agents::agents_deny_permission,
            daemon::agents::agents_list_secret_requests,
            daemon::agents::agents_fulfill_secret_request,
            daemon::agents::agents_deny_secret_request,
            ...
            daemon::bot::bot_list,
            daemon::bot::bot_create,
            daemon::bot::bot_get,
            daemon::bot::bot_update,
            daemon::bot::bot_set_archived,
            daemon::bot::bot_duplicate,
            daemon::bot::bot_open,
            daemon::bot::session_get_bot,
            daemon::bot::session_set_bot,
            daemon::bot::session_clear_bot,
            daemon::session::session_list,
            daemon::session::session_create,
            daemon::session::session_derive,
            daemon::session::prompt_stash_list,
            daemon::session::prompt_stash_create,
            daemon::session::prompt_stash_delete,
            daemon::shared_mode::shared_mode_status,
            daemon::shared_mode::shared_mode_set,
            daemon::session::session_set_display_name,
            daemon::session::agent_mode_list,
            daemon::session::agent_mode_transition_policy_get,
            daemon::session::agent_mode_transition_policy_set,
            daemon::session::session_get_agent_mode,
            daemon::session::session_set_agent_mode,
            daemon::session::session_list_agent_mode_proposals,
            daemon::session::session_decide_agent_mode_proposal,
            ...
            daemon::maintenance::storage_status,
            daemon::maintenance::storage_settings_update,
            daemon::maintenance::storage_maintenance_run,
