...
export function buildTheme(
  ...
  return {
    ...
    properties: {
      ...
      "--color-tertiary-50": accents.tertiary ?? accents.secondary,
      "--color-tertiary-100": accents.tertiary ?? accents.secondary,
      "--color-tertiary-200": accents.tertiary ?? accents.secondary,
      "--color-tertiary-300": accents.tertiary ?? accents.secondary,
      "--color-tertiary-400": accents.tertiary ?? accents.secondary,
      "--color-tertiary-500": accents.tertiary ?? accents.secondary,
      "--color-tertiary-600": accents.tertiary ?? accents.secondary,
      "--color-tertiary-700": accents.tertiary ?? accents.secondary,
      "--color-tertiary-800": accents.tertiary ?? accents.secondary,
      "--color-tertiary-900": accents.tertiary ?? accents.secondary,
