...
export function buildTheme(
  ...
  return {
    ...
    properties: {
      ...surfaces,
      ...accentRampProperties("primary", accents.primary),
      ...accentRampProperties("secondary", accents.secondary),
      ...accentRampProperties("tertiary", accents.tertiary ?? accents.secondary),
